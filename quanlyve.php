...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="quanlyve.php" class="sidebar-item active">
        ...
        <div class="main-box">
            ...
            <table class="movie-table">
                ...
                <tbody>
                    <tr>
                        <td>Thám tử Kiên</td>
                        <td><img src="#" alt="Poster" class="poster"></td>
                        <td>2025</td>
                        <td>Kinh dị, trinh thám</td>
                        <td>Tiếng Việt</td>
                        <td>18+</td>
                        <td>Đang chiếu</td>
                    </tr>
                    <tr>
                        <td>Hàng xóm của tôi là Totoro</td>
                        <td><img src="#" alt="Poster" class="poster"></td>
                        <td>1988</td>
                        <td>Hoạt hình</td>
                        <td>Tiếng Nhật phụ đề</td>
                        <td>Trẻ em 3+</td>
                        <td>Đang chiếu</td>
                    </tr>
                    <tr>
                        ...
                        <td><img src="#" alt="Poster" class="poster"></td>
                        <td>2022</td>
                        <td>Hàn Quốc, kinh dị, zombie</td>
                        <td>Tiếng Hàn phụ đề</td>
                        <td>18+</td>
                        <td>Đang chiếu</td>
                    </tr>
                </tbody>
